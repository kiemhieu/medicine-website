    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        foreach (var segment in Request.GetFriendlyUrlSegments())
        {
            if (segment.ToUpper() == Constant_Table.FIGURE.ToUpper())
            {
                ...
                searchConditions.Add(new SearchExpander("Id", "", typeof(string), true));
            ...
            else if (segment.ToUpper() == Constant_Table.MEDICINE.ToUpper())
            {
                ...
                List<SearchExpander> searchConditions = new List<SearchExpander>();
                searchConditions.Add(new SearchExpander(false, "ID", "Mã thuốc", null, typeof(int)));
                ...
                searchConditions.Add(new SearchExpander("Unit", "Đơn vị", typeof(int), "Id", "Name", typeof(Define), false));
                searchConditions.Add(new SearchExpander(false, "LastUpdatedDate", "Cập nhật ngày", null, typeof(DateTime)));
            ...
            else if (segment.ToUpper() == Constant_Table.MEDICINE_PLAN.ToUpper())
            {
                ...
                searchConditions.Add(new SearchExpander("CreatedUser", "Người lập", typeof(string), "Id", typeof(User)));
                searchConditions.Add(new SearchExpander("LastUpdatedDate", "Sửa lần cuối", typeof(DateTime)));
                searchConditions.Add(new SearchExpander("Date", "Ngày lập", typeof(DateTime)));
            ...
            else if (segment.ToUpper() == Constant_Table.WAREHOUSE.ToUpper())
            {
                ...
                searchConditions.Add(new SearchExpander("MinAllowed", "Tồn kho an toàn", typeof(int)));
                searchConditions.Add(new SearchExpander("Volumn", "Số lượng trong kho", typeof(int)));
